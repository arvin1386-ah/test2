...
def np():
    ...
    if place < 48:
        ...
        if place == 48:
            if(text2[place - 1]== '+' or text2[place - 1]== '-' or text2[place - 1]== '/' or  text2[place - 1]== '*'):
                e2.insert(place1, '(')
                counter += 1
                place += 1
                place1 += 1
            ...
            if text3[place1 ]== '+' or text3[place1 ]== '-' or text3[place1 ]== '/' or  text3[place1]== '*':   
                e2.insert(place1, '(')
                place1 +=1
                counter += 1
                place +=1 
